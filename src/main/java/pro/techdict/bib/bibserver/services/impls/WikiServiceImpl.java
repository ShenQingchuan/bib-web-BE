...
public class WikiServiceImpl implements WikiService {
    ...
    @Override
    public PageDto<WikiListItemDataDto> getWikiShowList(Long userId, int pageNum) {
    ...
    @Override
    public PageDto<DocShowInWikiListDto> getWikiAllDocsByPage(Long wikiId, int pageNum) {
