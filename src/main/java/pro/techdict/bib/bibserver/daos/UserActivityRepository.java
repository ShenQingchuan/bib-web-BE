...
public interface UserActivityRepository extends BaseRepository<UserActivity, Long> {
  ...
  @Query("select ua from UserActivity ua where ua.creator.userName = :userName")
  Page<UserActivity> fetchPageableActivities(@Param("userName") String userName, Pageable pageable);
